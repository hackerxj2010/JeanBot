...
class MissionExecutionBundle:
    ...
    audit_service: Union[LocalAuditService, HttpAuditService]
    memory_service: Union[LocalMemoryService, HttpMemoryService]
    file_service: LocalFileService
    runtime_service: Union[DeterministicRuntimeService, HttpRuntimeService]
    subagent_service: Union[DeterministicSubAgentService, HttpSubAgentService]
    policy_service: Union[StaticPolicyService, HttpPolicyService]
...
class MissionExecutorService:
    ...
    internal_token: str = field(
        default_factory=lambda: os.getenv("INTERNAL_SERVICE_TOKEN", "jeanbot-internal-dev-token")
    )
    ...
    def build_bundle(self, mission_payload: dict[str, Any]) -> MissionExecutionBundle:
        ...
        mode = mission_payload.get("service_mode", mission_payload.get("mode", self.service_mode))
        ...
        if mode == "http":
            ...
            policy_service = HttpPolicyService(
                api_url=api_url,
                internal_token=internal_token,
